 ...
 */
#define MOTOR_MAX_FORWARD_SPEED_MM_S       (120)
...
#define MOTOR_TARGET_RAMP_STEP_MM_S        (8)
#define MOTOR_PID_PWM_LIMIT                (120.0f)
...
#define MOTOR_SPEED_PID_KI                 (0.015f)
...
#define LINE_BASE_SPEED_MM_S               (72)
#define LINE_CORRECTION_SPEED_MM_S         (36)
...
#define LINE_TURN_OUTER_SPEED_MM_S         (36)
#define LINE_HARD_TURN_OUTER_SPEED_MM_S    (52)
