...
#define TRACK_MISSION_ARC_EXIT_RATE_X10    (60)   /* 6.0 deg/s */
#define TRACK_MISSION_ARC_EXIT_CONFIRM_MS  (200U)
#define TRACK_MISSION_ARC_EXIT_MAX_WAIT_MS (800U)
#define TRACK_MISSION_ARC_MIN_DURATION_MS  (1000U)
#define TRACK_MISSION_ARC_COOLDOWN_MS      (1500U)
