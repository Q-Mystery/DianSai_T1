...
#define LINE_TURN_LATCH_MS                 (160U)
#define LINE_LOST_RECOVERY_MS              (300U)
#define LINE_SOFT_TURN_INNER_SPEED_MM_S    (45)
#define LINE_SOFT_TURN_OUTER_SPEED_MM_S    (130)
#define LINE_MEDIUM_TURN_INNER_SPEED_MM_S  (10)
#define LINE_MEDIUM_TURN_OUTER_SPEED_MM_S  (145)
#define LINE_HARD_TURN_INNER_SPEED_MM_S    (0)
#define LINE_HARD_TURN_OUTER_SPEED_MM_S    (150)
#define LINE_LOST_RECOVERY_INNER_SPEED_MM_S (0)
#define LINE_LOST_RECOVERY_OUTER_SPEED_MM_S (140)
