...
#define LINE_STOP_DIAGNOSTIC_DISPLAY_ENABLE (1U)
#define LINE_STOP_DIAGNOSTIC_DISPLAY_MS    (250U)
#define LINE_STOP_ENCODER_DEADBAND_MM      (0.30f)
#define LINE_STOP_ENCODER_KP_MM_S_PER_MM   (1.20f)
#define LINE_STOP_ENCODER_MAX_DELTA_MM_S   (8)
...
#define TRACK_MISSION_ENTER_RATE_X10       (300)  /* 30.0 deg/s */
#define TRACK_MISSION_ENTER_WINDOW_MS      (2000U)
...
#define TRACK_MISSION_ARC_EXIT_RATE_X10    (300)  /* 30.0 deg/s */
...
#define LEFT_MOTOR_PWM_DEAD_ZONE           MOTOR_PWM_DEAD_ZONE
#define RIGHT_MOTOR_PWM_DEAD_ZONE          MOTOR_PWM_DEAD_ZONE
...
#define MOTOR_MAX_PWM_DEAD_ZONE \
    ((LEFT_MOTOR_PWM_DEAD_ZONE > RIGHT_MOTOR_PWM_DEAD_ZONE) ? \
        LEFT_MOTOR_PWM_DEAD_ZONE : RIGHT_MOTOR_PWM_DEAD_ZONE)
#define MOTOR_PID_PWM_LIMIT \
    ((MOTOR_TARGET_EFFECTIVE_PWM_DUTY > MOTOR_MAX_PWM_DEAD_ZONE) ? \
        ((float)(MOTOR_TARGET_EFFECTIVE_PWM_DUTY - MOTOR_MAX_PWM_DEAD_ZONE)) : \
        0.0f)
#define MOTOR_SPEED_FEEDFORWARD_PWM_PER_MM_S (4.20f)
#define LEFT_MOTOR_SPEED_FEEDFORWARD_PWM_PER_MM_S \
    MOTOR_SPEED_FEEDFORWARD_PWM_PER_MM_S
#define RIGHT_MOTOR_SPEED_FEEDFORWARD_PWM_PER_MM_S \
    MOTOR_SPEED_FEEDFORWARD_PWM_PER_MM_S
#define MOTOR_PID_CORRECTION_LIMIT         (120.0f)
#define MOTOR_STRAIGHT_SYNC_ENABLE         (0U)
#define MOTOR_STRAIGHT_SYNC_KP             (0.25f)
#define MOTOR_STRAIGHT_SYNC_LIMIT_PWM      (20.0f)

#define MOTOR_NOMINAL_DISTANCE_PER_COUNT_MM \
    (MECANUM_CIRCLE_MM / MD310_ENCODER_CIRCLE_PULSES)
#define LEFT_DISTANCE_PER_COUNT_MM         MOTOR_NOMINAL_DISTANCE_PER_COUNT_MM
#define RIGHT_DISTANCE_PER_COUNT_MM        MOTOR_NOMINAL_DISTANCE_PER_COUNT_MM
