 ...
 */
#define MOTOR_MAX_FORWARD_SPEED_MM_S       (140)
...
#define MOTOR_TARGET_RAMP_STEP_MM_S        (5)
#define MOTOR_PID_PWM_LIMIT                (100.0f)
 ...
 */
#define MOTOR_SPEED_PID_KP                 (0.28f)
...
#define LINE_BASE_SPEED_MM_S               (90)
#define LINE_CORRECTION_SPEED_MM_S         (44)
#define LINE_SEARCH_SPEED_MM_S             (12)
...
#define LINE_LOST_FORWARD_CYCLES           (24U)
#define LINE_TURN_INNER_SPEED_MM_S         (0)
#define LINE_SOFT_TURN_INNER_SPEED_MM_S    (36)
#define LINE_SOFT_TURN_OUTER_SPEED_MM_S    (60)
#define LINE_TURN_OUTER_SPEED_MM_S         (44)
#define LINE_HARD_TURN_OUTER_SPEED_MM_S    (56)
